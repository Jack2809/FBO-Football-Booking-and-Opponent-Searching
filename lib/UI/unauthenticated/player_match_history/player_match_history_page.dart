...
import 'package:football_booking_fbo_mobile/UI/unauthenticated/player_match_history/player_match_history_detail.dart';
import 'package:football_booking_fbo_mobile/constants.dart';
import '../../../Blocs/player_match_history/player_match_history_bloc.dart';
import '../../../Blocs/player_match_history/player_match_history_state.dart';
              ...
              builder: (context, state) {
                if (state is LoadingPlayerMatchHistory) {
                  ...
                  if (state.matchHistoryList.isEmpty) {
                    return Center(
                      child: Text('Không có lịch sử trận đấu nào của cầu thủ này'),
                    );
                  } else {

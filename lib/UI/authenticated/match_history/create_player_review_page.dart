...
class CreatePlayerReviewPage extends StatefulWidget{

  final int matchId;
  final int myTeamId;
  final PlayerReview playerReview;

  CreatePlayerReviewPage({required this.matchId,required this.myTeamId,required this.playerReview});

  @override
  State<CreatePlayerReviewPage> createState() => _CreateTeamPageState();
}

class _CreateTeamPageState extends State<CreatePlayerReviewPage> with InputPlayerReviewValidation{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Đánh giá cầu thủ',style: WhiteTitleText()),
        centerTitle: true,
        elevation: 0.0,
        bottomOpacity: 0.0,
                      ...
                      child: TextButton.icon(
                        onPressed: () {
                          if(formGlobalKey.currentState!.validate()) {
                            ...
                            add(CreatePlayerReview(matchId:widget.matchId,teamId: widget.myTeamId,reviewedPlayerId:widget.playerReview.playerId,comment:comment,star: star));
                            Navigator.of(context).pop();
                          }
                        },
